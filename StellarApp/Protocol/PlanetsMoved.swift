    ...
    static func getPlanets() -> [SCNNode] {
        ...
        for planetType in PlanetType.allCases {
            ...
            case .mercury:
                ...
                orbitNode.runAction(SCNAction.repeatForever(SCNAction.rotateBy(x: 0, y: 0.6, z: 0, duration: 1)))
            ...
            case .earth:
                ...
                let moonOrbitNode = SCNNode.getRings(radius: 0.47, vector: (x: 0, y: 0, z: 0), color: .clear)
                ...
                orbitNode.runAction(SCNAction.repeatForever(SCNAction.rotateBy(x: 0, y: 0.25, z: 0, duration: 1)))
                moonOrbitNode.runAction(SCNAction.repeatForever(SCNAction.rotateBy(x: 0, y: 0.2, z: 0, duration: 1)))
                planetNodes.append(orbitNode)
            ...
            case .mars:
                ...
                orbitNode.addChildNode(planetNode)
                orbitNode.runAction(SCNAction.repeatForever(SCNAction.rotateBy(x: 0, y: 0.2, z: 0, duration: 1)))
                planetNodes.append(orbitNode)
            ...
            case .jupiter:
                ...
                orbitNode.addChildNode(planetNode)
                orbitNode.runAction(SCNAction.repeatForever(SCNAction.rotateBy(x: 0, y: 0.45, z: 0, duration: 1)))
                planetNodes.append(orbitNode)
            ...
            case .saturn:
                ...
                orbitNode.runAction(SCNAction.repeatForever(SCNAction.rotateBy(x: 0, y: 0.35, z: 0, duration: 1)))
                planetNodes.append(orbitNode)
            ...
            case .pluto:
                ...
                orbitNode.addChildNode(planetNode)
                orbitNode.runAction(SCNAction.repeatForever(SCNAction.rotateBy(x: 0, y: 0.15, z: 0, duration: 1)))
                planetNodes.append(orbitNode)
            }
        }
        return planetNodes
